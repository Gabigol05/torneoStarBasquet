        ...
        <div className="footer-inner">
          <div className="footer-top">
            <div>
              ...
              <div className="footer-brand-sub">Básquet · Córdoba · 2025</div>
            ...
            <div>
              ...
              <ul className="footer-links">
                <li><a href="#femenino">Torneo Femenino</a></li>
                <li><a href="#masculino">Torneo Masculino</a></li>
          ...
          <div className="footer-bottom">
            <div className="footer-copy">© 2025 Torneo Star Básquet · Córdoba, Argentina · Todos los derechos reservados</div>
