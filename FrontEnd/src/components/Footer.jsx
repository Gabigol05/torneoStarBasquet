...
export function Footer() {
  return (
    <>
      <footer>
        <div className="footer-glow-br" aria-hidden="true"></div>
        <div className="footer-inner">
          <div className="footer-top">
            <div>
              <div className="footer-brand-row">
                <div className="footer-logo">
                  <img src={logoTorneo} alt="Torneo Star Basquet" loading="lazy" decoding="async"/>
                </div>
                <div>
              ...
              <p className="footer-desc">El torneo de basquet mas emocionante de Cordoba. Dos categorias, los mejores equipos y la pasion por el deporte.</p>
            </div>
            <div>
            ...
            <div>
              <div className="footer-col-title">Desarrollo</div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '9px' }}>
                <div>
                  <div style={{ fontFamily: "'Barlow Condensed'", fontWeight: 600, fontSize: '14px', color: 'var(--white)', marginBottom: '8px' }}>DS SoftwareStudio</div>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '9px' }}>
                    <a href="https://www.dssoftwarestudio.com.ar/" target="_blank" rel="noopener noreferrer" className="ig-link">
                      <span className="ig-link-icon">
                        <svg width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15.3 15.3 0 0 1 0 20M12 2a15.3 15.3 0 0 0 0 20"/></svg>
                      </span>
                      dssoftwarestudio.com.ar
                    </a>
                    <a href="https://www.instagram.com/ds.softwarestudio" target="_blank" rel="noopener noreferrer" className="ig-link">
                      <span className="ig-link-icon">
                  ...
                  <div style={{ fontFamily: "'Barlow Condensed'", fontSize: '12px', color: 'var(--gray)', marginTop: '8px' }}>dss.softwarestudio@gmail.com</div>
                </div>
              </div>
            </div>
          </div>
