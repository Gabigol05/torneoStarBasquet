    ...
    <>
      ...
      <nav>
        ...
        <ul className={`nav-links ${isMobileOpen ? 'mobile-open' : ''}`}>
          ...
          <li><a href="#femenino" className="nav-fem" onClick={() => setIsMobileOpen(false)}>♀ Femenino</a></li>
          <li><a href="#masculino" className="nav-masc" onClick={() => setIsMobileOpen(false)}>♂ Masculino</a></li>
