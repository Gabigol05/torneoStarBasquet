                    ...
                    <div
                      ...
                      <div className="flip-card-inner">
                        <div className="flip-card-front">
                          ...
                          <h3 className="fc-name">{team.name}</h3>
                          <div className="fc-subtitle" style={{ color: team.color }}>Torneo Masculino</div>
                        </div>
                        <div className="flip-card-back">
                          <img src={team.logo} alt="bg" className="fc-back-logo" loading="lazy" decoding="async"
                            onError={e => { e.target.style.display = 'none'; }}/>
                          <div className="fc-record-label">TORNEO MASCULINO</div>
                          <div className="fc-record-val" style={{ color: team.color }}>2026</div>
                          <div className="fc-team-name">{team.name}</div>
                        </div>
                      </div>
                    </div>
